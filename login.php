...
// scarico il modello per questa pagina, e' questo che il lavoro sporco
...
if(isset($_POST['submit']) && (trim($_POST['submit']) == "Login")) {
	...
	if( !isset($_POST['username']) || $_POST['username']=="" ) {
		...
		$username = strtolower(removeAccent(trim(filter_var($_POST['username'], FILTER_SANITIZE_STRING))));
		$password = strtolower(removeAccent(trim(filter_var($_POST['password'], FILTER_SANITIZE_STRING))));
